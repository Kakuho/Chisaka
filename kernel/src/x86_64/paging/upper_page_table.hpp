...
class UpperPageTable{
  ...
  public:
    ...
    constexpr const EntryType& GetEntry(std::size_t index) const noexcept {return m_entries[index];}

    constexpr EntryType& operator[](std::size_t index) noexcept {return m_entries[index];}
