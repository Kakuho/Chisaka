...
struct MemoryMapEntry{
  ...
  enum class Type: std::uint8_t{Useable, Reserved, AcpiReclaimable, AcpiNVS,
    BadMemory, BootLoaderReclaimable, Kernel, FrameBuffer, Empty,   // used as the default empty value
